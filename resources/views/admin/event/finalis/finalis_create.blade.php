            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        ...
                        <form action="{{ route('finalis.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row needs-validation" novalidate>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="no_kandidat" id="noKandidat" class="form-control"
                                        value="{{ old('no_kandidat') }}" placeholder="Masukkan Nomor Kandidat" required>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <textarea name="deskripsi_kandidat" id="deskripsiKandidat" rows="3" class="form-control"
                                        placeholder="Masukkan deskripsi (jika ada)">{{ old('deskripsi_kandidat') }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <textarea name="biografi_kandidat" id="biografiKandidat" rows="4" class="form-control"
                                        placeholder="Masukkan biografi (jika ada)">{{ old('biografi_kandidat') }}</textarea>
                                </div>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        border-radius: 10px;">
                                                ...
                                                <div class="change-btn d-flex align-items-center flex-wrap mt-2">
                                                    ...
                                                    <label for="imageUpload" class="btn btn-primary ms-0">Pilih Foto</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
